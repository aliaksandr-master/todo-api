...
class CI_DB_active_record extends CI_DB_driver {
    ...
    function bracketCloseWhere() {
        return self::bracket('close', 'where');
    }

    function bracketCloseLike() {
        return self::bracket('close', 'like');
    }
