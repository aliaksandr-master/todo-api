define(function(require, exports, module){
	...
	var template = require('templates/modules/crm/setting/leed/type/types/types');
	var SettingLeedTypeItemView = require('./type');
	require('css!styles/modules/crm/setting/leed/type/types/types');

	var SettingLeedTypeListView = BaseCollectionView.extend({

		noWrap: true,

		itemView: SettingLeedTypeItemView,
	...
	return SettingLeedTypeListView;
});